...
impl ElementInternals {
    fn new_inherited(element: &HTMLElement) -> ElementInternals {
        ElementInternals {
            ...
            // "" instead of null because of whatwg/html#5263
            submission_value: DomRefCell::new(SubmissionValue::USVString(USVString::from(
                "".to_string(),
            ))),
            state: DomRefCell::new(SubmissionValue::USVString(USVString::from("".to_string()))),
